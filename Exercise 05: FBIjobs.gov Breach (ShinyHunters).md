...
* **MITRE ATT&CK Technique:** **Defacement: External Defacement** (`T1491.002`)
...
* **MITRE ATT&CK Tactics:** Discovery (`TA0007`) / Collection (`TA0009`)
* **MITRE ATT&CK Techniques:** **Cloud Infrastructure Discovery** (`T1580`) / **Data from Information Repositories** (`T1213`)
...
* **MITRE ATT&CK Tactic:** Impact (`TA0040`)
* **MITRE ATT&CK Technique:** **Financial Theft / Extortion** (`T1657`)
